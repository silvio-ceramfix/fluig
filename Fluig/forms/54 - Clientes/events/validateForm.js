function validateForm(form){
	...
	if ( getValue("WKNextState") == 5 && getValue("WKCompletTask") && form.getValue("situacao_cadastro") == 'A' ){		
		...
		try{
		    ...
		    log.info("## RESULT POST 3 ## "+form.getValue( 'tipo_cadastro' ) );
		    ...
		    // var campoCheckbox = form.getValue("editName") == "on" ? true : false;
		     ...
		     log.info( 'Agora....'+form.getValue( "valEditName" ) );
		     if ( form.getValue( "valEditName" ) == 'N' )
		     ...
		     if ( getValueForm( "endereco_cob", "" ) != "" ){ 
		    	 lr_cliente["tip_endereco_end_cob"] = getValueForm( "tipo_logradouro_cob", "C" )+"";
		    	 lr_cliente["sequencia_end_cob"] = "1";
		    	 lr_cliente["tip_logradouro_end_cob"] = getValueForm( "tipo_logradouro_cob", "" )+"";
		    	 lr_cliente["logradouro_end_cob"] = getValueForm( "endereco_cob", "" )+"";
		    	 lr_cliente["num_iden_lograd_end_cob"] = getValueForm( "numero_cob", "S/N" )+"";
		    	 lr_cliente["complemento_endereco_end_cob"] = getValueForm( "complemento_cob", "0" )+"";
		    	 lr_cliente["bairro_cobr_entga"] = getValueForm( "bairro_cob", getValueForm( "bairro_cob_sel", "" ) )+"";
		    	 lr_cliente["cod_cidade_end_cob"] = getValueForm( "cod_cidade_cob", "" )+"";
		    	 lr_cliente["cod_cep_end_cob"] = getValueForm( "cep_cob", "0" )+"";
		     }else{
		     ...
		     lr_cliente["cod_tip_carteira"] = getValueForm( "cod_tip_carteira", "01" )+"";
		     ...
		     lr_cliente["qtd_dias_atr_dupl"] = getValueForm( "qtd_dias_atr_dupl", "0" )+"";
		     lr_cliente["qtd_dias_atr_med"] = getValueForm( "qtd_dias_atr_med", "0" )+"";
		     lr_cliente["val_ped_carteira"] = getValueForm( "val_ped_carteira", "0" )+"";
		     lr_cliente["val_dup_aberto"] = getValueForm( "val_dup_aberto", "0" )+"";
		     lr_cliente["dat_ult_fat"] = getValueForm( "dat_ult_fat", dataTxt )+"";
		     lr_cliente["val_limite_cred"] = getValueForm( "val_limite_cred", "0" )+"";
		     lr_cliente["dat_val_lmt_cr"] = getValueForm( "dat_val_lmt_cr", dataTxt )+"";
		     lr_cliente["ies_nota_debito"] = 'N'+"";
		     lr_cliente["ies_protesto"] = getValueForm( "ies_protesto", "S" )+"";
		     lr_cliente["ies_emis_autom_nd"] = getValueForm( "ies_emis_autom_nd", "N" )+"";
		     lr_cliente["tex_obs"] = getValueForm( "tex_obs", "0" )+"";
		     lr_cliente["qtd_dias_protesto"] = getValueForm( "qtd_dias_protesto", "0" )+"";
		     lr_cliente["ies_tip_cliente"] = getValueForm( "ies_tip_cliente", "" )+"";
		     lr_cliente["cod_float"] = getValueForm( "cod_float", "0" )+"";
		     lr_cliente["email_boleto"] = getValueForm( "e_mail_cob", "" )+""; 
	
		      params["lr_cliente"] = lr_cliente; 
		      
		      var la_cli_contatos = [];
		      var indexes = form.getChildrenIndexes("contatos");
		      log.info( 'Contatos..............'+indexes.length );
		      for (var i = 1; i < indexes.length+1; i++) {
		    	  var contato = {};	    	  
		    	  contato["num_contato"] = i+"";
		    	  contato["nom_contato"] = getValueForm( "nome_contato___"+i, "" )+"";
		    	  contato["cod_cargo"] = getValueForm( "tipo_contato___"+i, "" )+"";
		    	  contato["dat_nascimento"] = getValueForm( "dat_nascimento___"+i, "" )+"";
		    	  contato["num_telefone"] = getValueForm( "fone_contato___"+i, "" )+"";
		    	  contato["num_fax"] = getValueForm( "celular_contato___"+i, "" )+"";
		    	  contato["email"] = getValueForm( "email_contato___"+i, "" )+"";
		    	  contato["cod_hobby"] = getValueForm( "cod_hobby___"+i, "" )+"";
		    	  contato["num_ramal"] = getValueForm( "num_ramal___"+i, "" )+"";
		    	  contato["departnto"] = getValueForm( "departnto___"+i, "" )+"";
		    	  contato["setor"] = getValueForm( "setor___"+i, "" )+"";
		    	  contato["observacao"] = getValueForm( "observacao___"+i, "" )+"";
		      ...
		      var indexes = form.getChildrenIndexes("socios_diretores");
		      log.info( 'Socios..............'+indexes.length );
		      for (var i = 1; i < indexes.length+1; i++) {
		    	  var socio = {};
		    	  socio["num_cpf_socio"] = getValueForm( "cpf_socio___"+i, "" )+"";
		    	  socio["nom_socio"] = getValueForm( "nome_socio___"+i, "" )+"";
		      ...
		      var indexes = form.getChildrenIndexes("lista_email");
		      log.info( 'Lista Mail..............'+indexes.length );
		      for (var i = 1; i < indexes.length+1; i++) {
		    	  var mail = {};
		    	  mail["grupo_email"] = getValueForm( "grupo_email___"+i, "1" )+"";
		    	  mail["seq_email"] = i+"";
		    	  mail["email"] = getValueForm( "email___"+i, "" )+"";
		    	  mail["tip_registro"] = "C";
		    	  mail["des_grupo_email"] = getValueForm( "des_grupo_email___"+i, "NFe XML" )+"";
